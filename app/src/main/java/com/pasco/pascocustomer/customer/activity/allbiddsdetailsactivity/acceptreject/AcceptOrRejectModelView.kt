...
@HiltViewModel
class AcceptOrRejectModelView @Inject constructor(
    ...
    fun otpCheck(id: String, acceptBody: AcceptOrRejectBidBody, activity: Activity, progressDialog: CustomProgressDialog) {
        progressDialog.start(activity.getString(R.string.please_wait))
        progressIndicator.value = true
        repository.acceptReject(acceptBody,id).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread())
