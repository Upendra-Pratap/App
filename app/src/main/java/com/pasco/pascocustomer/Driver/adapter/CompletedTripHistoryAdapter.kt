...
class CompletedTripHistoryAdapter(private val context: Context, private val driverTripHistory:List<CompletedTripHistoryResponse.DriverTripHistoryData>)  :
    RecyclerView.Adapter<CompletedTripHistoryAdapter.ViewHolder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CompletedTripHistoryAdapter.ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.recycler_driver_trip_history,parent,false)
